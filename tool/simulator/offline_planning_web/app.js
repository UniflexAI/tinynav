...
const SCENARIOS = {
  ...
  s_bend: {
    label: "S bend",
    start: { xy: [0.0, -0.8], yaw_deg: 0.0 },
    target: [5.8, 0.4, 0.0],
    cameraMaxRange: 8.0,
    bounds: { xMin: -0.8, xMax: 6.8, yMin: -2.6, yMax: 2.6 },
    objects: [
      simBox("lower_wall_entry", [1.4, -1.95, 0.65], [3.4, 0.22, 1.3]),
      simBox("upper_wall_entry", [1.85, 1.06, 0.65], [4.3, 0.22, 1.3]),
      simBox("lower_wall_exit", [4.7, -1.06, 0.65], [3.4, 0.22, 1.3]),
      simBox("upper_wall_exit", [4.7, 1.95, 0.65], [3.4, 0.22, 1.3]),
      simBox("left_deflector", [2.65, -1.145, 0.65], [0.22, 1.39, 1.3]),
      simBox("right_deflector", [4.15, 1.145, 0.65], [0.22, 1.39, 1.3]),
    ],
  },
  narrow_gate: {
    label: "Narrow gate",
