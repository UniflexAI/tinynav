...
class MapNode(Node):
    ...
    def keyframe_callback(self, keyframe_image_msg:Image, keyframe_odom_msg:Odometry, depth_msg:Image):
        ...
        print(f"keyframe_relocalization success: {success}")
        if success:
            self.compute_transform_from_map_to_odom()
        print(f"compute_transform_from_map_to_odom success: {success}")
    ...
    def keyframe_relocalization(self, timestamp, image:np.ndarray) -> tuple[bool, np.ndarray]:
        ...
        print(f"relocalize_with_depth success: {res}")
        if res:
            ...
            print(f"failed relocalization, timestamp: {timestamp}")
