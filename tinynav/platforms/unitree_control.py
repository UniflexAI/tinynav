...
UNITREE_SDK_DIR = os.path.join(REPO_ROOT, "unitree_sdk2_python")
if UNITREE_SDK_DIR not in sys.path:
    sys.path.insert(0, UNITREE_SDK_DIR)
...
from unitree_sdk2py.a2w.sport.sport_client import SportClient as SportClientA2W
...
class Ros2UnitreeManagerNode(Node):
    def __init__(self, networkInterface: str = "enP8p1s0"):
        ...
        self.sport_client = SportClientA2W()
