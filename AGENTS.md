...
- Typical ROS topics: `/camera/camera/infra1|infra2/image_rect_raw`, `/camera/camera/accel|gyro/sample`, `/slam/odometry`, `/slam/depth`, `/slam/keyframe_*`, `/planning/trajectory_path`, `/planning/height_map`, `/cmd_vel`.
